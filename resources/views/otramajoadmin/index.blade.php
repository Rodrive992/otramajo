...
.panel-card{
    background: var(--om-blanco); border:1px solid var(--om-gris-claro);
    border-radius: 1rem; padding: 1.25rem; text-align:center;
    transition: transform .2s ease, box-shadow .2s ease;
    box-shadow: 0 8px 24px rgba(0,0,0,.06);
}
.panel-card:hover{ transform: translateY(-4px); box-shadow: 0 14px 36px rgba(0,0,0,.08); }
</style>
...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="#" class="panel-card">
            <div class="text-xl font-semibold mb-1">Entrevistas</div>
